 ...
 * @description 产品详情视图对象
 * @auther wangsheng
 * @creatTime 2022/1/5 上午1:33
 * @company 四川省万源市一生活智能科技有限公司
 * @department 小程序-微信小程序
 */
public class SpecificationVO extends TblSpecification implements Serializable {
    ...
    public SpecificationVO(String createUser, Date createTime, String updateUser, Date updateTime, String remark,
