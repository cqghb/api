...
public class SpecificationController {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(SpecificationController.class);

    @Autowired
    private ITblSpecificationService specificationService;
    ...
    public Result updateDelTag(@RequestBody @Validated CommonIdDto ddDto) {
        TblSpecification specification = new TblSpecification();
        specification.setId(ddDto.getId());
        int num = specificationService.updateDelTag(specification);
        return ResultUtil.success(num);
    }
}
