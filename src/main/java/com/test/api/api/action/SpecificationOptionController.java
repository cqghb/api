...
public class SpecificationOptionController {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(SpecificationOptionController.class);
    ...
    public Result findPage(@RequestBody PageRequest pageQuery) {
        PageResult pageResult = specificationOptionService.findPage(pageQuery);
    ...
    public Result queryById(@RequestBody @Validated CommonIdDto ddDto) {
        TblSpecificationOption spuBrand = specificationOptionService.selectByPrimaryKey(ddDto.getId());
    ...
    public Result updateDelTag(@RequestBody @Validated CommonIdDto ddDto) {
        ...
        specificationOption.setId(ddDto.getId());
        int num = specificationOptionService.updateDelTag(specificationOption);
