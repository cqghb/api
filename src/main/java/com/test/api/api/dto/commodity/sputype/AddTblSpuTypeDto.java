 ...
 * @projectName api
 * @package com.test.api.api.dto.commodity.sputype
 * @className AddTblSpuTypeDto
 * @description 添加货品类型表单对象
 * @auther wangsheng
 * @creatTime 2022/1/9 下午12:08
 * @company 四川省万源市一生活智能科技有限公司
 * @department 小程序-微信小程序
 */
public class AddTblSpuTypeDto extends BaseDto implements Serializable {
    ...
    public AddTblSpuTypeDto() {
    }

    public AddTblSpuTypeDto(String remark, String delTag, @NotNull(message = "货品类型名称不能为空") @NotBlank(message =
            "货品类型名称不能为空") String name,
    ...
    public String toString() {
        return "AddTblSpuTypeDto{" + JSONObject.toJSONString(this) + "}";
    }
}
